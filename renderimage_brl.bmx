...
Function CreateRenderImageContext:TRenderImageContext(gc:TGraphics)
	...
	Assert max2d <> Null
?win32
	If TD3D9Graphics(max2d._graphics) Return New TD3D9RenderImageContext.Create(max2d)
	If TD3D11Graphics(max2d._graphics) Return New TD3D11RenderImageContext.Create(max2d)
?
	If TGLGraphics(max2d._graphics) Return New TGLRenderImageContext.Create(max2d)
